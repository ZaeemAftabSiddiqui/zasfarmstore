        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src="https://m.media-amazon.com/images/I/91E5KUZ3KzL._SL1500_.jpg"
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="leading-relaxed">
                ...
                It is the state bird of Rhode Island. It was developed there and
                in Massachusetts in the late nineteenth century, by
                cross-breeding birds of Oriental origin such as the Malay with
                brown Leghorn birds from Italy. Primary use: Egg, Meat Egg
                production (annual): 260 Egg size: Extra Large Temperament:
                Hardy Recognized variety: Rose Comb, Single Comb Egg color:
                Brown Adult male weight (lbs.): ≥ 8.5
              </p>
                  ...
                  {Object.keys(variants).includes("green") &&
                    Object.keys(variants["green"]).includes(size) && (
                      <button
                        ...
                        className={`border-2  ml-1 bg-emerald-200 rounded-full w-6 h-6 focus:outline-none ${
                          color === "green" ? "border-black" : "border-gray-300"
                        }`}
                      ></button>
                    )}
                  {Object.keys(variants).includes("Dark brown") &&
                    Object.keys(variants["Dark brown"]).includes(size) && (
                      <button
                        onClick={() => {
                          refreshVariant(size, "Dark brown");
                        }}
                        className={`border-2 ml-1 bg-orange-800 rounded-full w-6 h-6 focus:outline-none ${
                          color === "Dark brown"
                            ? "border-black"
                            : "border-gray-300"
                        }`}
                  ...
                  {Object.keys(variants).includes("pink") &&
                    Object.keys(variants["pink"]).includes(size) && (
                      <button
                        ...
                        className={`border-2 ml-1 bg-orange-200 rounded-full w-6 h-6 focus:outline-none ${
